...
const MOCK_DATA: CommentReportItem[] = [
  { id: 1, postTitle: 'React 상태 관리 완벽 정리', comment: '이 글 완전 쓰레기네요', reportType: '욕설/혐오', reportedAt: '2026-03-01', content: '욕설이 포함된 댓글입니다.', status: '대기중' },
  { id: 2, postTitle: 'TypeScript 제네릭 활용법',  comment: '광고 클릭하면 할인 받아요!', reportType: '스팸', reportedAt: '2026-03-03', content: '광고성 댓글입니다.', status: '처리중' },
  { id: 3, postTitle: 'TanStack Router 시작하기',  comment: '이 내용은 제 블로그에서 가져간 겁니다.', reportType: '저작권 침해', reportedAt: '2026-03-05', content: '무단 복제 관련 신고입니다.', status: '처리완료' },
  { id: 4, postTitle: 'Tailwind CSS 고급 패턴',    comment: '19금 내용 링크입니다 http://...', reportType: '부적절 콘텐츠', reportedAt: '2026-03-06', content: '부적절한 외부 링크가 포함되어 있습니다.', status: '반려' },
  { id: 5, postTitle: 'Vite 빌드 최적화',          comment: '그냥 신고해봄', reportType: '기타', reportedAt: '2026-03-07', content: '기타 사유로 신고합니다.', status: '대기중' },
];
...
export function CommentReport() {
  ...
  const activeTags = [
    ...
    ...selectedStatuses.map((s) => ({ key: `status-${s}`, label: s, onRemove: () => toggleStatus(s) })),
        ...
        <TableBody>
          {MOCK_DATA.map((item) => (
            <TableRow key={item.id}>
              ...
              <TableCell className="text-muted-foreground max-w-40 truncate">{item.comment}</TableCell>
              <TableCell>
              ...
              <TableCell>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem>답변</DropdownMenuItem>
                    <DropdownMenuSeparator />
